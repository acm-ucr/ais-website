...
const About = () => {
  return (
    <div className="flex flex-col lg:flex-row mx-10 py-12 sm:px-10 gap-10 justify-center font-nunito items-center lg:items-start">
      <Image
        src={GroupPhoto}
        alt="AIS Group Photo"
      ...
      <div className="flex flex-col justify-center space-y-6 mr-12 lg:w-2/3 py-5 text-left">
